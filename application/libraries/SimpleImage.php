 ...
 * @author      Michael Erwin Virgines <michael.erwinp@gmail.com> - adding tile overlay function, codeigniter fix.
...
class SimpleImage {
     ...
     * Adaptive resize
     *
     * This public function has been deprecated and will be removed in an upcoming release. Please
    ...
    public function overlay($overlay, $position = 'center', $opacity = 1, $x_offset = 0, $y_offset = 0) {
        ...
        if ($isTile) {
            ...
            imagesavealpha($overlay->image, true);
            imagealphablending($overlay->image, true);
            imagesettile ($this->image, $overlay->image);
     ...
     *
     */
    public function imagettfstroketext(&$image, $size, $angle, $x, $y, &$textcolor, &$strokecolor, $stroke_size, $fontfile, $text) {
     ...
     *
     */
    public function keep_within($value, $min, $max) {
