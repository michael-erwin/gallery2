...
class M_video extends CI_Model
{
     ...
     */
    public function isPresent ($file_hash)
    {
        $sql = "SELECT `id` FROM `videos` WHERE `checksum`='{$file_hash}'";
    ...
    */
    public function add ($title = null, $uid = null, $width=null, $height=null, $size=null, $checksum=null, $category=null, $duration)
    {
        if ($title && $uid && $width && $height)
        {
            ...
            $sql  = "INSERT INTO `videos` SET `category_id`={$category}, `title`={$title}, `uid`='{$uid}', `width`={$width}, `height`={$height}, `file_size`={$size}, `checksum`='{$checksum}'";
            ...
            else
            {
                ...
                if(count($category_data) > 0)
                {
                    ...
                    if($category_data['sc_type']=="video" && $category_data['sc_level']==2 && $category_data['mc_level']==1)
                    {
            ...
            $sql .= ", `duration`={$duration}, date_added={$date}";
