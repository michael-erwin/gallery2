    ...
    */
    public function add ($title = null, $uid = null, $width=null, $height=null, $size=null, $checksum=null, $category=null, $duration)
    {
        if ($title && $uid && $width && $height)
        {
            ...
            $sql = "INSERT INTO `videos` SET `category_id`={$category}, `title`={$title}, `uid`='{$uid}', `width`={$width}, `height`={$height}, `file_size`={$size}, `checksum`='{$checksum}', `duration`={$duration}, date_added={$date}";
