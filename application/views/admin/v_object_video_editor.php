<div class="modal common" id="modal_video_editor" tabindex="-1" role="dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="modal-media-box">
                        <div data-id="video">
                            <video id="video_edit_player" class="video-js vjs-default-skin vjs-big-play-centered">
                    ...
                    <div class="modal-info-box">
                        <div class="meta clearfix">
                            ...
                            <div class="meta-value" data-id="duration"></div>
                        </div>
                        <hr>
